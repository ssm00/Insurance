...
public class PremiumRate {
	...
	public PremiumRate(int coverageAmount, String coverageEvent, int coveragePeriod, String coverageTarget, int insuranceFee) {
		final float COVERAGE_AMOUNT_MULTIPLIER = 0.005f;
		final float COVERAGE_PERIOD_MULTIPLIER = 0.02f;
		final float COVERAGE_TARGET_MULTIPLIER = 0.05f;
		final float INSURANCE_FEE_MULTIPLIER = 0.01f;
